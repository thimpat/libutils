...
📁 package                
│
└───📝 lib-utils.cjs             ⇽ CJS version      - Node (40.0k unminified)
│  
└───📝 lib-utils.mjs             ⇽ ESM version      - Node (38.3k unminified)
│
└───📁 dist
│   │
│   │ 📝 lib-utils.mjs           ⇽ ESM version      - Browser (38.3k unminified)
│   │ 📝 lib-utils.min.mjs       ⇽ ESM version      - Browser (11.5k minified)
