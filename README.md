...
📁 package                
│
└───📝 lib-utils.cjs             ⇽ CJS version      - Node (40.2k unminified)
│  
└───📝 lib-utils.mjs             ⇽ ESM version      - Node (38.5k unminified)
│
└───📁 dist
│   │
│   │ 📝 lib-utils.mjs           ⇽ ESM version      - Browser (38.5k unminified)
│   │ 📝 lib-utils.min.mjs       ⇽ ESM version      - Browser (11.6k minified)
