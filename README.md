...
📁 package                
│
└───📝 lib-utils.cjs             ⇽ CJS version      - Node (39.5k unminified)
│  
└───📝 lib-utils.mjs             ⇽ ESM version      - Node (37.8k unminified)
│
└───📁 dist
│   │
│   │ 📝 lib-utils.mjs           ⇽ ESM version      - Browser (37.8k unminified)
│   │ 📝 lib-utils.min.mjs       ⇽ ESM version      - Browser (11.3k minified)
