...
📁 package                
│
└───📝 lib-utils.cjs             ⇽ CJS version      - Node (41.4k unminified)
│  
└───📝 lib-utils.mjs             ⇽ ESM version      - Node (41.3k unminified)
│
└───📁 dist
│   │
│   │ 📝 lib-utils.mjs           ⇽ ESM version      - Browser (37.6k unminified)
│   │ 📝 lib-utils.min.mjs       ⇽ ESM version      - Browser (11.4k minified)
